# Xbox One (GDK) post-project hook: code_gen source discovery, includes, defines
# Detected via: CMAKE_GENERATOR_PLATFORM = "Gaming.Xbox.XboxOne.x64"
...
target_compile_definitions(${PROJECT_NAME} PRIVATE OS_GDK OS_XBOX_ONE EXTGEN_HAS_JNI=0)

# TODO: Add Xbox One-specific GDK link libraries.
# GDK include/lib paths are auto-injected by Visual Studio for Gaming.Xbox.XboxOne.x64.

message(STATUS "Including Xbox One sources")
