...
namespace gm_enums
{
    ...
    enum class FmodChannelControlCallbackType : std::int64_t
    {
        End = 0,
        VirtualVoice = 1,
        SyncPoint = 2,
    ...
    enum class FmodDspCallbackType : std::int64_t
    {
        DataParameterRelease = 0
    };

    enum class FmodDspParameterDataType : std::int64_t
    {
        User = 0,
        OverallGain = -1,
        _3DAttributes = -2,
    ...
    enum class FmodSystemCallbackType : std::int64_t
    {
        DeviceListChanged = 1,
        DeviceLost = 2,
    ...
    enum class FmodErrorCallbackInstanceType : std::int64_t
    {
        None = 0,
        System = 1,
        Channel = 2,
...
namespace gm_structs
{
    ...
    struct FmodErrorCallbackInfo
    {
        gm_enums::FmodResult result;
        gm_enums::FmodErrorCallbackInstanceType instance_type;
    ...
    struct FmodSystemDeviceReinitialize
    {
        gm_enums::FmodOutputType output_type;
        double driver_index;
    };
    ...
    struct FmodDSPDescription
    {
        double pluginsdkversion;
        std::string name;
        double version;
        double numinputbuffers;
    ...
    struct FmodDSPConnectionEnd
    {
        std::uint64_t dsp_ref;
        std::uint64_t connection_ref;
    };
...
namespace gm::wire::codec
{
    ...
    inline void writeValue<gm_structs::FmodDSPMixMatrix>(gm::byteio::IByteWriter& _buf, const gm_structs::FmodDSPMixMatrix& obj)
    {
        ...
        gm::wire::codec::writeValue(_buf, obj.required_bytes);
    }
    ...
    inline gm_structs::FmodDSPMixMatrix readValue<gm_structs::FmodDSPMixMatrix>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.required_bytes = gm::wire::codec::readValue<double>(_buf);
        return obj;
    }
    ...
    template<>
    inline void writeValue<gm_structs::FmodDSPDataParameterInfo>(gm::byteio::IByteWriter& _buf, const gm_structs::FmodDSPDataParameterInfo& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.index);
        gm::wire::codec::writeValue(_buf, obj.length);
    }

    template<>
    inline gm_structs::FmodDSPDataParameterInfo readValue<gm_structs::FmodDSPDataParameterInfo>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::FmodDSPDataParameterInfo obj;
        obj.index = gm::wire::codec::readValue<double>(_buf);
        obj.length = gm::wire::codec::readValue<double>(_buf);
        return obj;
    }

    template<>
    inline void writeValue<gm_structs::FmodErrorCallbackInfo>(gm::byteio::IByteWriter& _buf, const gm_structs::FmodErrorCallbackInfo& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.result);
        gm::wire::codec::writeValue(_buf, obj.instance_type);
        gm::wire::codec::writeValue(_buf, obj.instance);
        gm::wire::codec::writeValue(_buf, obj.function_name);
        gm::wire::codec::writeValue(_buf, obj.function_params);
    }

    template<>
    inline gm_structs::FmodErrorCallbackInfo readValue<gm_structs::FmodErrorCallbackInfo>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::FmodErrorCallbackInfo obj;
        obj.result = gm::wire::codec::readValue<gm_enums::FmodResult>(_buf);
        obj.instance_type = gm::wire::codec::readValue<gm_enums::FmodErrorCallbackInstanceType>(_buf);
        obj.instance = gm::wire::codec::readValue<std::uint64_t>(_buf);
        obj.function_name = gm::wire::codec::readValue<std::string>(_buf);
        obj.function_params = gm::wire::codec::readValue<std::string>(_buf);
        return obj;
    }

    template<>
    inline void writeValue<gm_structs::FmodSystemDeviceReinitialize>(gm::byteio::IByteWriter& _buf, const gm_structs::FmodSystemDeviceReinitialize& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.output_type);
        gm::wire::codec::writeValue(_buf, obj.driver_index);
    }

    template<>
    inline gm_structs::FmodSystemDeviceReinitialize readValue<gm_structs::FmodSystemDeviceReinitialize>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::FmodSystemDeviceReinitialize obj;
        obj.output_type = gm::wire::codec::readValue<gm_enums::FmodOutputType>(_buf);
        obj.driver_index = gm::wire::codec::readValue<double>(_buf);
        return obj;
    }

    template<>
    inline void writeValue<gm_structs::FmodSystemMemoryAllocationFailed>(gm::byteio::IByteWriter& _buf, const gm_structs::FmodSystemMemoryAllocationFailed& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.file);
        gm::wire::codec::writeValue(_buf, obj.size);
    }

    template<>
    inline gm_structs::FmodSystemMemoryAllocationFailed readValue<gm_structs::FmodSystemMemoryAllocationFailed>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::FmodSystemMemoryAllocationFailed obj;
        obj.file = gm::wire::codec::readValue<std::string>(_buf);
        obj.size = gm::wire::codec::readValue<double>(_buf);
        return obj;
    }

    template<>
    inline void writeValue<gm_structs::FmodSystemRecordPosition>(gm::byteio::IByteWriter& _buf, const gm_structs::FmodSystemRecordPosition& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.sound_ref);
        gm::wire::codec::writeValue(_buf, obj.position);
    }

    template<>
    inline gm_structs::FmodSystemRecordPosition readValue<gm_structs::FmodSystemRecordPosition>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::FmodSystemRecordPosition obj;
        obj.sound_ref = gm::wire::codec::readValue<std::uint64_t>(_buf);
    ...
    template<>
    inline void writeValue<gm_structs::FmodDSPDescription>(gm::byteio::IByteWriter& _buf, const gm_structs::FmodDSPDescription& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.pluginsdkversion);
        gm::wire::codec::writeValue(_buf, obj.name);
        gm::wire::codec::writeValue(_buf, obj.version);
        gm::wire::codec::writeValue(_buf, obj.numinputbuffers);
        gm::wire::codec::writeValue(_buf, obj.numoutputbuffers);
        gm::wire::codec::writeValue(_buf, obj.numparameters);
    }

    template<>
    inline gm_structs::FmodDSPDescription readValue<gm_structs::FmodDSPDescription>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::FmodDSPDescription obj;
        obj.pluginsdkversion = gm::wire::codec::readValue<double>(_buf);
        obj.name = gm::wire::codec::readValue<std::string>(_buf);
        obj.version = gm::wire::codec::readValue<double>(_buf);
        obj.numinputbuffers = gm::wire::codec::readValue<double>(_buf);
        obj.numoutputbuffers = gm::wire::codec::readValue<double>(_buf);
        obj.numparameters = gm::wire::codec::readValue<double>(_buf);
        return obj;
    }

    template<>
    inline void writeValue<gm_structs::FmodDSPConnectionEnd>(gm::byteio::IByteWriter& _buf, const gm_structs::FmodDSPConnectionEnd& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.dsp_ref);
        gm::wire::codec::writeValue(_buf, obj.connection_ref);
    }

    template<>
    inline gm_structs::FmodDSPConnectionEnd readValue<gm_structs::FmodDSPConnectionEnd>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::FmodDSPConnectionEnd obj;
        obj.dsp_ref = gm::wire::codec::readValue<std::uint64_t>(_buf);
        obj.connection_ref = gm::wire::codec::readValue<std::uint64_t>(_buf);
        return obj;
    }
...
namespace gm::wire::details
{
    ...
    template<>
    struct gm_struct_traits<gm_structs::FmodDSPDataParameterInfo>
    {
        static constexpr bool is_gm_struct = true;
    ...
    template<>
    struct gm_struct_traits<gm_structs::FmodErrorCallbackInfo>
    {
        static constexpr bool is_gm_struct = true;
    ...
    template<>
    struct gm_struct_traits<gm_structs::FmodSystemDeviceReinitialize>
    {
        static constexpr bool is_gm_struct = true;
    ...
    template<>
    struct gm_struct_traits<gm_structs::FmodSystemMemoryAllocationFailed>
    {
        static constexpr bool is_gm_struct = true;
    ...
    template<>
    struct gm_struct_traits<gm_structs::FmodSystemRecordPosition>
    {
        static constexpr bool is_gm_struct = true;
    ...
    template<>
    struct gm_struct_traits<gm_structs::FmodDSPDescription>
    {
        static constexpr bool is_gm_struct = true;
    ...
    template<>
    struct gm_struct_traits<gm_structs::FmodDSPConnectionEnd>
    {
        static constexpr bool is_gm_struct = true;
...
gm_structs::FmodDSPDescription fmod_system_get_dsp_info_by_type(gm_enums::FmodDspType dsp_type);
...
double fmod_sound_set_user_data(std::uint64_t sound_ref, std::int64_t user_data);
std::int64_t fmod_sound_get_user_data(std::uint64_t sound_ref);
...
double fmod_sound_group_set_user_data(std::uint64_t sound_group_ref, std::int64_t user_data);
std::int64_t fmod_sound_group_get_user_data(std::uint64_t sound_group_ref);
...
double fmod_reverb_3d_set_user_data(std::uint64_t reverb_3d_ref, std::int64_t user_data);
std::int64_t fmod_reverb_3d_get_user_data(std::uint64_t reverb_3d_ref);
...
std::vector<gm_structs::FmodFadePoint> fmod_channel_control_get_fade_points(std::uint64_t channel_control_ref);
...
double fmod_channel_control_get_3d_custom_rolloff(std::uint64_t channel_control_ref, gm::wire::GMBuffer points);
...
double fmod_channel_control_set_mix_levels_input(std::uint64_t channel_control_ref, gm::wire::GMBuffer levels, double num_levels);
double fmod_channel_control_set_mix_matrix(std::uint64_t channel_control_ref, gm::wire::GMBuffer matrix, double out_channels, double in_channels, double in_channel_hop);
gm_structs::FmodDSPMixMatrix fmod_channel_control_get_mix_matrix(std::uint64_t channel_control_ref, gm::wire::GMBuffer matrix, double in_channel_hop);
...
double fmod_channel_control_set_user_data(std::uint64_t channel_control_ref, std::int64_t user_data);
...
double fmod_channel_control_set_callback(std::uint64_t channel_control_ref, const std::optional<gm::wire::GMFunction>& callback);
...
gm_structs::FmodDSPConnectionEnd fmod_dsp_get_input(std::uint64_t dsp_ref, double index);
gm_structs::FmodDSPConnectionEnd fmod_dsp_get_output(std::uint64_t dsp_ref, double index);
void fmod_dsp_disconnect_from(std::uint64_t dsp_ref, std::uint64_t target_dsp);
double fmod_dsp_get_data_parameter_index(std::uint64_t dsp_ref, gm_enums::FmodDspParameterDataType data_type);
...
std::int64_t fmod_dsp_get_user_data(std::uint64_t dsp_ref);
...
double fmod_dsp_connection_set_mix_matrix(std::uint64_t connection_ref, gm::wire::GMBuffer matrix, double out_channels, double in_channels, double in_channel_hop);
