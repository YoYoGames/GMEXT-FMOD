...
show_debug_message("master: " + fmod_error_string(fmod_studio_last_result()));
...
show_debug_message("masterstrings: " + fmod_error_string(fmod_studio_last_result()));
sfx_bank_index = fmod_studio_system_load_bank_file(fmod_path_bundle("SFX.bank"),FmodStudioLoadBankFlags.Normal);
show_debug_message("SFX: " + fmod_error_string(fmod_studio_last_result()));
