...
enum FmodAudioQueueCodecPolicy
{
    Default = 0,
    SoftwareOnly = 1,
    HardwareOnly = 2
...
enum FmodChannelControlCallbackType
{
    End = 0,
    VirtualVoice = 1,
    SyncPoint = 2,
...
enum FmodDspParameterDataType
{
    ...
    SideChain = -3,
    Fft = -4,
    _3DAttributesMulti = -5,
    AttenuationRange = -6,
    DynamicResponse = -7
}

enum FmodSystemCallbackType
{
    DeviceListChanged = 1,
    DeviceLost = 2,
...
enum FmodErrorCallbackInstanceType
{
    None = 0,
    System = 1,
    Channel = 2,
    ...
    Reverb3D = 10,
    StudioSystem = 11,
    StudioEventDescription = 12,
    StudioEventInstance = 13,
    StudioParameterInstance = 14,
    StudioBus = 15,
    StudioVca = 16,
    StudioBank = 17,
    StudioCommandReplay = 18
}
 ...
 */
function FmodRecordNumDrivers() constructor
{
    /**
     * Internally generated hash for quick validation
     * @ignore
     */
    static __uid = 2113704961;

    self.num_drivers = undefined;
    self.num_connected = undefined;
...
/**
 * @returns {Struct.FmodDSPDataParameterInfo}
 */
function FmodDSPDataParameterInfo() constructor
{
    /**
     * Internally generated hash for quick validation
     * @ignore
     */
    static __uid = 306806701;
...
/**
 * @returns {Struct.FmodErrorCallbackInfo}
 */
function FmodErrorCallbackInfo() constructor
{
    /**
     * Internally generated hash for quick validation
     * @ignore
     */
    static __uid = 3221815260;

    self.result = undefined;
    self.instance_type = undefined;
    self.instance = undefined;
    self.function_name = undefined;
    self.function_params = undefined;

}

/**
 * @returns {Struct.FmodSystemDeviceReinitialize}
 */
function FmodSystemDeviceReinitialize() constructor
{
    /**
     * Internally generated hash for quick validation
     * @ignore
     */
    static __uid = 3051743479;

    self.output_type = undefined;
    self.driver_index = undefined;

}

/**
 * @returns {Struct.FmodSystemMemoryAllocationFailed}
 */
function FmodSystemMemoryAllocationFailed() constructor
{
    /**
     * Internally generated hash for quick validation
     * @ignore
     */
    static __uid = 1402386334;
...
/**
 * @returns {Struct.FmodSystemRecordPosition}
 */
function FmodSystemRecordPosition() constructor
{
    /**
     * Internally generated hash for quick validation
     * @ignore
     */
    static __uid = 2572458368;

    self.sound_ref = undefined;
 ...
 */
function FmodDSPDescription() constructor
{
    /**
     * Internally generated hash for quick validation
     * @ignore
     */
    static __uid = 1863727068;

    self.pluginsdkversion = undefined;
    self.name = undefined;
    self.version = undefined;
    self.numinputbuffers = undefined;
    self.numoutputbuffers = undefined;
    self.numparameters = undefined;
 ...
 */
function FmodDSPConnectionEnd() constructor
{
    /**
     * Internally generated hash for quick validation
     * @ignore
     */
    static __uid = 1972682779;

    self.dsp_ref = undefined;
    self.connection_ref = undefined;
 ...
 */
function FmodChannelsPlaying() constructor
{
    /**
     * Internally generated hash for quick validation
     * @ignore
     */
    static __uid = 1191515555;

    self.channels = undefined;
    self.real_channels = undefined;
...
function FmodSoundNumTags() constructor
{
     ...
     * @ignore
     */
    static __uid = 3617479007;

    self.num_tags = undefined;
    self.num_tags_updated = undefined;
 ...
 */
function FmodSoundFormatInfo() constructor
{
    /**
     * Internally generated hash for quick validation
     * @ignore
     */
    static __uid = 4067960909;
...
function FmodCreateSoundExInfo() constructor
{
    ...
    self.ignore_set_filesystem = false;
...
/**
 * @func __FmodRecordNumDrivers_encode(_inst, _buffer, _offset, _where)
 * @param {Struct.FmodRecordNumDrivers} _inst
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @param {String} _where
 * @ignore
 */
function __FmodRecordNumDrivers_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
        // field: num_drivers, type: Float64
        if (!is_numeric(self.num_drivers)) show_error($"{_where} :: self.num_drivers expected number", true);
        buffer_write(_buffer, buffer_f64, self.num_drivers);

        // field: num_connected, type: Float64
        if (!is_numeric(self.num_connected)) show_error($"{_where} :: self.num_connected expected number", true);
        buffer_write(_buffer, buffer_f64, self.num_connected);

    }
}

/**
 * @func __FmodRecordNumDrivers_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.FmodRecordNumDrivers}
 * @ignore
 */
function __FmodRecordNumDrivers_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);

    _inst = new FmodRecordNumDrivers();
    with (_inst)
    {
        // field: num_drivers, type: Float64
        self.num_drivers = buffer_read(_buffer, buffer_f64);

        // field: num_connected, type: Float64
        self.num_connected = buffer_read(_buffer, buffer_f64);
...
function __FmodDSPMixMatrix_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        // field: required_bytes, type: Float64
        if (!is_numeric(self.required_bytes)) show_error($"{_where} :: self.required_bytes expected number", true);
        buffer_write(_buffer, buffer_f64, self.required_bytes);
...
function __FmodDSPMixMatrix_decode(_buffer, _offset)
{
    ...
    with (_inst)
    {
        ...
        // field: required_bytes, type: Float64
        self.required_bytes = buffer_read(_buffer, buffer_f64);
...
function __FmodDSPChannelFormat_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        buffer_write(_buffer, buffer_u64, self.channel_mask);
...
function __FmodDSPChannelFormat_decode(_buffer, _offset)
{
    ...
    {
        // field: channel_mask, type: enum FmodChannelMask
        self.channel_mask = buffer_read(_buffer, buffer_u64);
...
function __FmodDSPMeteringEnabled_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        if (!is_bool(self.input_enabled)) show_error($"{_where} :: self.input_enabled expected bool", true);
        buffer_write(_buffer, buffer_bool, self.input_enabled);

        // field: output_enabled, type: Bool
        if (!is_bool(self.output_enabled)) show_error($"{_where} :: self.output_enabled expected bool", true);
        buffer_write(_buffer, buffer_bool, self.output_enabled);
...
/**
 * @func __FmodDSPDataParameterInfo_encode(_inst, _buffer, _offset, _where)
 * @param {Struct.FmodDSPDataParameterInfo} _inst
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @param {String} _where
 * @ignore
 */
function __FmodDSPDataParameterInfo_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
        // field: index, type: Float64
        if (!is_numeric(self.index)) show_error($"{_where} :: self.index expected number", true);
        buffer_write(_buffer, buffer_f64, self.index);
...
/**
 * @func __FmodDSPDataParameterInfo_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.FmodDSPDataParameterInfo}
 * @ignore
 */
function __FmodDSPDataParameterInfo_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);

    _inst = new FmodDSPDataParameterInfo();
    with (_inst)
    {
        // field: index, type: Float64
        self.index = buffer_read(_buffer, buffer_f64);
...
/**
 * @func __FmodErrorCallbackInfo_encode(_inst, _buffer, _offset, _where)
 * @param {Struct.FmodErrorCallbackInfo} _inst
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @param {String} _where
 * @ignore
 */
function __FmodErrorCallbackInfo_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
        ...
        // field: instance_type, type: enum FmodErrorCallbackInstanceType

        if (!is_numeric(self.instance_type)) show_error($"{_where} :: self.instance_type expected number", true);
        buffer_write(_buffer, buffer_u64, self.instance_type);

        // field: instance, type: UInt64
        if (!is_numeric(self.instance)) show_error($"{_where} :: self.instance expected number", true);
        buffer_write(_buffer, buffer_u64, self.instance);

        // field: function_name, type: String
        if (!is_string(self.function_name)) show_error($"{_where} :: self.function_name expected string", true);
        buffer_write(_buffer, buffer_u32, string_byte_length(self.function_name));
        buffer_write(_buffer, buffer_string, self.function_name);

        // field: function_params, type: String
        if (!is_string(self.function_params)) show_error($"{_where} :: self.function_params expected string", true);
        buffer_write(_buffer, buffer_u32, string_byte_length(self.function_params));
        buffer_write(_buffer, buffer_string, self.function_params);

    }
}

/**
 * @func __FmodErrorCallbackInfo_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.FmodErrorCallbackInfo}
 * @ignore
 */
function __FmodErrorCallbackInfo_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);

    _inst = new FmodErrorCallbackInfo();
    with (_inst)
    {
        // field: result, type: enum FmodResult
        ...
        // field: instance_type, type: enum FmodErrorCallbackInstanceType
        self.instance_type = buffer_read(_buffer, buffer_u64);

        // field: instance, type: UInt64
        self.instance = buffer_read(_buffer, buffer_u64);

        // field: function_name, type: String
        buffer_read(_buffer, buffer_u32);
        self.function_name = buffer_read(_buffer, buffer_string);

        // field: function_params, type: String
        buffer_read(_buffer, buffer_u32);
        self.function_params = buffer_read(_buffer, buffer_string);
...
/**
 * @func __FmodSystemDeviceReinitialize_encode(_inst, _buffer, _offset, _where)
 * @param {Struct.FmodSystemDeviceReinitialize} _inst
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @param {String} _where
 * @ignore
 */
function __FmodSystemDeviceReinitialize_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
        // field: output_type, type: enum FmodOutputType

        if (!is_numeric(self.output_type)) show_error($"{_where} :: self.output_type expected number", true);
        buffer_write(_buffer, buffer_u64, self.output_type);

        // field: driver_index, type: Float64
        if (!is_numeric(self.driver_index)) show_error($"{_where} :: self.driver_index expected number", true);
        buffer_write(_buffer, buffer_f64, self.driver_index);

    }
}

/**
 * @func __FmodSystemDeviceReinitialize_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.FmodSystemDeviceReinitialize}
 * @ignore
 */
function __FmodSystemDeviceReinitialize_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);

    _inst = new FmodSystemDeviceReinitialize();
    with (_inst)
    {
        // field: output_type, type: enum FmodOutputType
        self.output_type = buffer_read(_buffer, buffer_u64);

        // field: driver_index, type: Float64
        self.driver_index = buffer_read(_buffer, buffer_f64);
...
/**
 * @func __FmodSystemMemoryAllocationFailed_encode(_inst, _buffer, _offset, _where)
 * @param {Struct.FmodSystemMemoryAllocationFailed} _inst
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @param {String} _where
 * @ignore
 */
function __FmodSystemMemoryAllocationFailed_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
        // field: file, type: String
        if (!is_string(self.file)) show_error($"{_where} :: self.file expected string", true);
        buffer_write(_buffer, buffer_u32, string_byte_length(self.file));
        buffer_write(_buffer, buffer_string, self.file);
...
/**
 * @func __FmodSystemMemoryAllocationFailed_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.FmodSystemMemoryAllocationFailed}
 * @ignore
 */
function __FmodSystemMemoryAllocationFailed_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);

    _inst = new FmodSystemMemoryAllocationFailed();
    with (_inst)
    {
        // field: file, type: String
        buffer_read(_buffer, buffer_u32);
        self.file = buffer_read(_buffer, buffer_string);
...
/**
 * @func __FmodSystemRecordPosition_encode(_inst, _buffer, _offset, _where)
 * @param {Struct.FmodSystemRecordPosition} _inst
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @param {String} _where
 * @ignore
 */
function __FmodSystemRecordPosition_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
        // field: sound_ref, type: UInt64
        if (!is_numeric(self.sound_ref)) show_error($"{_where} :: self.sound_ref expected number", true);
        buffer_write(_buffer, buffer_u64, self.sound_ref);
...
/**
 * @func __FmodSystemRecordPosition_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.FmodSystemRecordPosition}
 * @ignore
 */
function __FmodSystemRecordPosition_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);

    _inst = new FmodSystemRecordPosition();
    with (_inst)
    {
        // field: sound_ref, type: UInt64
        self.sound_ref = buffer_read(_buffer, buffer_u64);
...
/**
 * @func __FmodDSPDescription_encode(_inst, _buffer, _offset, _where)
 * @param {Struct.FmodDSPDescription} _inst
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @param {String} _where
 * @ignore
 */
function __FmodDSPDescription_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
        // field: pluginsdkversion, type: Float64
        if (!is_numeric(self.pluginsdkversion)) show_error($"{_where} :: self.pluginsdkversion expected number", true);
        buffer_write(_buffer, buffer_f64, self.pluginsdkversion);
        ...
        // field: numinputbuffers, type: Float64
        if (!is_numeric(self.numinputbuffers)) show_error($"{_where} :: self.numinputbuffers expected number", true);
        buffer_write(_buffer, buffer_f64, self.numinputbuffers);

        // field: numoutputbuffers, type: Float64
        if (!is_numeric(self.numoutputbuffers)) show_error($"{_where} :: self.numoutputbuffers expected number", true);
        buffer_write(_buffer, buffer_f64, self.numoutputbuffers);

        // field: numparameters, type: Float64
        if (!is_numeric(self.numparameters)) show_error($"{_where} :: self.numparameters expected number", true);
        buffer_write(_buffer, buffer_f64, self.numparameters);

    }
}

/**
 * @func __FmodDSPDescription_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.FmodDSPDescription}
 * @ignore
 */
function __FmodDSPDescription_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);

    _inst = new FmodDSPDescription();
    with (_inst)
    {
        // field: pluginsdkversion, type: Float64
        self.pluginsdkversion = buffer_read(_buffer, buffer_f64);
        ...
        // field: numinputbuffers, type: Float64
        self.numinputbuffers = buffer_read(_buffer, buffer_f64);

        // field: numoutputbuffers, type: Float64
        self.numoutputbuffers = buffer_read(_buffer, buffer_f64);

        // field: numparameters, type: Float64
        self.numparameters = buffer_read(_buffer, buffer_f64);
...
/**
 * @func __FmodDSPConnectionEnd_encode(_inst, _buffer, _offset, _where)
 * @param {Struct.FmodDSPConnectionEnd} _inst
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @param {String} _where
 * @ignore
 */
function __FmodDSPConnectionEnd_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
        // field: dsp_ref, type: UInt64
        if (!is_numeric(self.dsp_ref)) show_error($"{_where} :: self.dsp_ref expected number", true);
        buffer_write(_buffer, buffer_u64, self.dsp_ref);

        // field: connection_ref, type: UInt64
        if (!is_numeric(self.connection_ref)) show_error($"{_where} :: self.connection_ref expected number", true);
        buffer_write(_buffer, buffer_u64, self.connection_ref);

    }
}

/**
 * @func __FmodDSPConnectionEnd_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.FmodDSPConnectionEnd}
 * @ignore
 */
function __FmodDSPConnectionEnd_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);

    _inst = new FmodDSPConnectionEnd();
    with (_inst)
    {
        // field: dsp_ref, type: UInt64
        self.dsp_ref = buffer_read(_buffer, buffer_u64);

        // field: connection_ref, type: UInt64
        self.connection_ref = buffer_read(_buffer, buffer_u64);
...
/**
 * @func __FmodChannelsPlaying_encode(_inst, _buffer, _offset, _where)
 * @param {Struct.FmodChannelsPlaying} _inst
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @param {String} _where
 * @ignore
 */
function __FmodChannelsPlaying_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
        ...
        // field: real_channels, type: Float64
        if (!is_numeric(self.real_channels)) show_error($"{_where} :: self.real_channels expected number", true);
        buffer_write(_buffer, buffer_f64, self.real_channels);

    }
}

/**
 * @func __FmodChannelsPlaying_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.FmodChannelsPlaying}
 * @ignore
 */
function __FmodChannelsPlaying_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);

    _inst = new FmodChannelsPlaying();
    with (_inst)
    {
        // field: channels, type: Float64
        self.channels = buffer_read(_buffer, buffer_f64);
        ...
        // field: real_channels, type: Float64
        self.real_channels = buffer_read(_buffer, buffer_f64);
...
function __FmodDelay_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        if (!is_bool(self.stop_channels)) show_error($"{_where} :: self.stop_channels expected bool", true);
        buffer_write(_buffer, buffer_bool, self.stop_channels);
...
function __FmodSoundOpenState_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        if (!is_bool(self.starving)) show_error($"{_where} :: self.starving expected bool", true);
        buffer_write(_buffer, buffer_bool, self.starving);

        // field: disk_busy, type: Bool
        if (!is_bool(self.disk_busy)) show_error($"{_where} :: self.disk_busy expected bool", true);
        buffer_write(_buffer, buffer_bool, self.disk_busy);
...
function __FmodSoundTag_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        if (!is_bool(self.updated)) show_error($"{_where} :: self.updated expected bool", true);
        buffer_write(_buffer, buffer_bool, self.updated);
...
/**
 * @func __FmodSoundNumTags_encode(_inst, _buffer, _offset, _where)
 * @param {Struct.FmodSoundNumTags} _inst
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @param {String} _where
 * @ignore
 */
function __FmodSoundNumTags_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
        // field: num_tags, type: Float64
        if (!is_numeric(self.num_tags)) show_error($"{_where} :: self.num_tags expected number", true);
        buffer_write(_buffer, buffer_f64, self.num_tags);

        // field: num_tags_updated, type: Float64
        if (!is_numeric(self.num_tags_updated)) show_error($"{_where} :: self.num_tags_updated expected number", true);
        buffer_write(_buffer, buffer_f64, self.num_tags_updated);

    }
}

/**
 * @func __FmodSoundNumTags_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.FmodSoundNumTags}
 * @ignore
 */
function __FmodSoundNumTags_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);

    _inst = new FmodSoundNumTags();
    with (_inst)
    {
        // field: num_tags, type: Float64
        self.num_tags = buffer_read(_buffer, buffer_f64);

        // field: num_tags_updated, type: Float64
        self.num_tags_updated = buffer_read(_buffer, buffer_f64);
...
/**
 * @func __FmodSoundFormatInfo_encode(_inst, _buffer, _offset, _where)
 * @param {Struct.FmodSoundFormatInfo} _inst
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @param {String} _where
 * @ignore
 */
function __FmodSoundFormatInfo_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
        // field: type, type: enum FmodSoundType
        ...
        // field: bits, type: Float64
        if (!is_numeric(self.bits)) show_error($"{_where} :: self.bits expected number", true);
        buffer_write(_buffer, buffer_f64, self.bits);

    }
}

/**
 * @func __FmodSoundFormatInfo_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.FmodSoundFormatInfo}
 * @ignore
 */
function __FmodSoundFormatInfo_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);

    _inst = new FmodSoundFormatInfo();
    with (_inst)
    {
        // field: type, type: enum FmodSoundType
        self.type = buffer_read(_buffer, buffer_u64);
        ...
        // field: bits, type: Float64
        self.bits = buffer_read(_buffer, buffer_f64);
...
function __FmodDistanceFilter_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        if (!is_bool(self.custom)) show_error($"{_where} :: self.custom expected bool", true);
        buffer_write(_buffer, buffer_bool, self.custom);
...
function __FmodPolygonAttributes_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        if (!is_bool(self.double_sided)) show_error($"{_where} :: self.double_sided expected bool", true);
        buffer_write(_buffer, buffer_bool, self.double_sided);
...
function __FmodAdvancedSettings_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        // field: resampler_method, type: enum FmodDspResampler

        if (!is_numeric(self.resampler_method)) show_error($"{_where} :: self.resampler_method expected number", true);
        buffer_write(_buffer, buffer_u64, self.resampler_method);
...
function __FmodAdvancedSettings_decode(_buffer, _offset)
{
    ...
    with (_inst)
    {
        ...
        // field: resampler_method, type: enum FmodDspResampler
        self.resampler_method = buffer_read(_buffer, buffer_u64);
...
function __FmodStreamBufferSize_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        buffer_write(_buffer, buffer_u64, self.file_buffer_size_type);
...
function __FmodStreamBufferSize_decode(_buffer, _offset)
{
    ...
    with (_inst)
    {
        ...
        // field: file_buffer_size_type, type: enum FmodTimeUnit
        self.file_buffer_size_type = buffer_read(_buffer, buffer_u64);
...
function __FmodCreateSoundExInfo_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    ...
    with (_inst)
    {
        ...
        // field: suggested_sound_type, type: enum FmodSoundType

        if (!is_numeric(self.suggested_sound_type)) show_error($"{_where} :: self.suggested_sound_type expected number", true);
        buffer_write(_buffer, buffer_u64, self.suggested_sound_type);

        // field: file_buffer_size, type: Float64
        if (!is_numeric(self.file_buffer_size)) show_error($"{_where} :: self.file_buffer_size expected number", true);
        buffer_write(_buffer, buffer_f64, self.file_buffer_size);

        // field: channel_order, type: enum FmodChannelOrder

        if (!is_numeric(self.channel_order)) show_error($"{_where} :: self.channel_order expected number", true);
        buffer_write(_buffer, buffer_u64, self.channel_order);
        ...
        // field: initial_seek_pos_type, type: enum FmodTimeUnit

        if (!is_numeric(self.initial_seek_pos_type)) show_error($"{_where} :: self.initial_seek_pos_type expected number", true);
        buffer_write(_buffer, buffer_u64, self.initial_seek_pos_type);

        // field: ignore_set_filesystem, type: Bool
        if (!is_bool(self.ignore_set_filesystem)) show_error($"{_where} :: self.ignore_set_filesystem expected bool", true);
        buffer_write(_buffer, buffer_bool, self.ignore_set_filesystem);
        ...
        buffer_write(_buffer, buffer_u64, self.audio_queue_policy);
...
function __FmodCreateSoundExInfo_decode(_buffer, _offset)
{
    ...
    with (_inst)
    {
        ...
        // field: suggested_sound_type, type: enum FmodSoundType
        self.suggested_sound_type = buffer_read(_buffer, buffer_u64);

        // field: file_buffer_size, type: Float64
        self.file_buffer_size = buffer_read(_buffer, buffer_f64);

        // field: channel_order, type: enum FmodChannelOrder
        self.channel_order = buffer_read(_buffer, buffer_u64);
...
function fmod_thread_set_attributes(_thread_type, _affinity, _priority)
{
    ...
    // param: _thread_type, type: enum FmodThreadType

    if (!is_numeric(_thread_type)) show_error($"{_GMFUNCTION_} :: _thread_type expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _thread_type);

    // param: _affinity, type: Float64
    if (!is_numeric(_affinity)) show_error($"{_GMFUNCTION_} :: _affinity expected number", true);
    buffer_write(__args_buffer__, buffer_f64, _affinity);

    // param: _priority, type: enum FmodThreadPriority
 ...
 * @param {Enum.FmodTimeUnit} _time_unit
 * @returns {Real}
 */
function fmod_channel_set_position(_channel_ref, _position, _time_unit)
{
    ...
    // param: _time_unit, type: enum FmodTimeUnit

    if (!is_numeric(_time_unit)) show_error($"{_GMFUNCTION_} :: _time_unit expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _time_unit);
 ...
 * @param {Enum.FmodTimeUnit} _loop_start_type
 * @param {Real} _loop_end
 * @param {Enum.FmodTimeUnit} _loop_end_type
 * @returns {Real}
 */
function fmod_channel_set_loop_points(_channel_ref, _loop_start, _loop_start_type, _loop_end, _loop_end_type)
{
    ...
    // param: _loop_start_type, type: enum FmodTimeUnit

    if (!is_numeric(_loop_start_type)) show_error($"{_GMFUNCTION_} :: _loop_start_type expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _loop_start_type);
    ...
    // param: _loop_end_type, type: enum FmodTimeUnit

    if (!is_numeric(_loop_end_type)) show_error($"{_GMFUNCTION_} :: _loop_end_type expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _loop_end_type);
...
/**
 * @param {Real} _channel_ref
 * @param {Enum.FmodTimeUnit} _start_type
 * @param {Enum.FmodTimeUnit} _end_type
 * @returns {Struct.FmodLoopPoints}
 */
function fmod_channel_get_loop_points(_channel_ref, _start_type, _end_type)
{
    ...
    // param: _start_type, type: enum FmodTimeUnit

    if (!is_numeric(_start_type)) show_error($"{_GMFUNCTION_} :: _start_type expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _start_type);

    // param: _end_type, type: enum FmodTimeUnit

    if (!is_numeric(_end_type)) show_error($"{_GMFUNCTION_} :: _end_type expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _end_type);
...
/**
 * @param {Real} _max_channels
 * @param {Enum.FmodInitFlags} _flags
 * @returns {Real}
 */
function fmod_system_init(_max_channels, _flags)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    // param: _max_channels, type: Float64
    if (!is_numeric(_max_channels)) show_error($"{_GMFUNCTION_} :: _max_channels expected number", true);
    buffer_write(__args_buffer__, buffer_f64, _max_channels);

    // param: _flags, type: enum FmodInitFlags

    if (!is_numeric(_flags)) show_error($"{_GMFUNCTION_} :: _flags expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _flags);

    var __return_value__ = __fmod_system_init(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__));
...
function fmod_system_get_channels_playing()
{
    ...
    var __return_value__ = __fmod_system_get_channels_playing(buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));

    var __result__ = undefined;
    __result__ = __FmodChannelsPlaying_decode(__ret_buffer__, buffer_tell(__ret_buffer__));
    return __result__;
}
...
function fmod_system_get_record_num_drivers()
{
    ...
    var __return_value__ = __fmod_system_get_record_num_drivers(buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));

    var __result__ = undefined;
    __result__ = __FmodRecordNumDrivers_decode(__ret_buffer__, buffer_tell(__ret_buffer__));
    return __result__;
}
...
function fmod_system_record_start(_device_index, _sound_ref, _loop)
{
    ...
    // param: _loop, type: Bool
    if (!is_bool(_loop)) show_error($"{_GMFUNCTION_} :: _loop expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _loop);
 ...
 * @returns {Struct.FmodDSPDescription}
 */
function fmod_system_get_dsp_info_by_type(_dsp_type)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    var __return_value__ = __fmod_system_get_dsp_info_by_type(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));

    var __result__ = undefined;
    __result__ = __FmodDSPDescription_decode(__ret_buffer__, buffer_tell(__ret_buffer__));
    return __result__;
}
...
/**
 * @param {Real} _file_buffer_size
 * @param {Enum.FmodTimeUnit} _file_buffer_size_type
 * @returns {Real}
 */
function fmod_system_set_stream_buffer_size(_file_buffer_size, _file_buffer_size_type)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    // param: _file_buffer_size, type: Float64
    if (!is_numeric(_file_buffer_size)) show_error($"{_GMFUNCTION_} :: _file_buffer_size expected number", true);
    buffer_write(__args_buffer__, buffer_f64, _file_buffer_size);

    // param: _file_buffer_size_type, type: enum FmodTimeUnit

    if (!is_numeric(_file_buffer_size_type)) show_error($"{_GMFUNCTION_} :: _file_buffer_size_type expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _file_buffer_size_type);

    var __return_value__ = __fmod_system_set_stream_buffer_size(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__));
...
function fmod_system_play_dsp(_dsp_ref, _channel_group_ref, _paused)
{
    ...
    // param: _paused, type: Bool
    if (!is_bool(_paused)) show_error($"{_GMFUNCTION_} :: _paused expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _paused);
...
/**
 * @param {Enum.FmodSpeaker} _speaker
 * @returns {Struct.FmodSpeakerPosition}
 */
function fmod_system_get_speaker_position(_speaker)
{
    ...
    // param: _speaker, type: enum FmodSpeaker

    if (!is_numeric(_speaker)) show_error($"{_GMFUNCTION_} :: _speaker expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _speaker);

    var __ret_buffer__ = __ext_core_get_ret_buffer();

    var __return_value__ = __fmod_system_get_speaker_position(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
 ...
 * @returns {Real}
 */
function fmod_system_set_speaker_position(_speaker, _x, _y, _active)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    var __return_value__ = __fmod_system_set_speaker_position(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__));
 ...
 * @param {Id.Buffer} _matrix
 * @returns {Struct.FmodDSPMixMatrix}
 */
function fmod_system_get_default_mix_matrix(_source_speaker_mode, _target_speaker_mode, _matrix)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    // param: _matrix, type: Buffer
    if (!buffer_exists(_matrix)) show_error($"{_GMFUNCTION_} :: _matrix expected Id.Buffer", true);
    __GMFMOD_queue_buffer(buffer_get_address(_matrix), buffer_get_size(_matrix));
 ...
 * @param {Enum.FmodSystemCallbackType} _callback_mask
 * @returns {Real}
 */
function fmod_system_set_callback(_callback, _callback_mask)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    // param: _callback_mask, type: enum FmodSystemCallbackType

    if (!is_numeric(_callback_mask)) show_error($"{_GMFUNCTION_} :: _callback_mask expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _callback_mask);

    var __return_value__ = __fmod_system_set_callback(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__));
...
function fmod_system_get_user_data()
{
    ...
    var __return_value__ = __fmod_system_get_user_data(buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
 ...
 * @returns {Real}
 */
function fmod_system_set_user_data(_user_data)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    var __return_value__ = __fmod_system_set_user_data(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__));

    return __return_value__;
}

/**
 * @param {Enum.FmodPortType} _port_type
 * @param {Real} _port_index
 * @param {Real} _channel_group_ref
 * @param {Bool} _pass_thru
 * @returns {Real}
 */
function fmod_system_attach_channel_group_to_port(_port_type, _port_index, _channel_group_ref, _pass_thru)
{
    ...
    // param: _port_type, type: enum FmodPortType

    if (!is_numeric(_port_type)) show_error($"{_GMFUNCTION_} :: _port_type expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _port_type);
    ...
    // param: _pass_thru, type: Bool
    if (!is_bool(_pass_thru)) show_error($"{_GMFUNCTION_} :: _pass_thru expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _pass_thru);
...
function fmod_system_create_sound(_name_or_data, _mode)
{
    ...
    // param: _mode, type: enum FmodMode
    ...
    var __return_value__ = __fmod_system_create_sound(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function fmod_system_create_stream(_name_or_data, _mode)
{
    ...
    var __return_value__ = __fmod_system_create_stream(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
 ...
 * @returns {Real}
 */
function fmod_system_create_sound_memory(_data, _length, _mode)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    var __return_value__ = __fmod_system_create_sound_memory(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
 ...
 * @returns {Real}
 */
function fmod_system_create_sound_memory_ex(_data, _length, _mode, _ex_info)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    var __return_value__ = __fmod_system_create_sound_memory_ex(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function fmod_system_play_sound(_sound_ref, _channel_group_ref, _pause)
{
    ...
    // param: _pause, type: Bool
    if (!is_bool(_pause)) show_error($"{_GMFUNCTION_} :: _pause expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _pause);
...
/**
 * @param {Real} _sound_ref
 * @param {Enum.FmodTimeUnit} _length_type
 * @returns {Real}
 */
function fmod_sound_get_length(_sound_ref, _length_type)
{
    ...
    // param: _length_type, type: enum FmodTimeUnit

    if (!is_numeric(_length_type)) show_error($"{_GMFUNCTION_} :: _length_type expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _length_type);
...
function fmod_sound_get_mode(_sound_ref)
{
    ...
    var __return_value__ = __fmod_sound_get_mode(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function fmod_sound_get_format(_sound_ref)
{
    ...
    var __return_value__ = __fmod_sound_get_format(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));

    var __result__ = undefined;
    __result__ = __FmodSoundFormatInfo_decode(__ret_buffer__, buffer_tell(__ret_buffer__));
    return __result__;
}
...
function fmod_sound_set_3d_custom_rolloff(_sound_ref, _points, _num_points)
{
    ...
    // param: _points, type: Buffer
    if (!buffer_exists(_points)) show_error($"{_GMFUNCTION_} :: _points expected Id.Buffer", true);
    __GMFMOD_queue_buffer(buffer_get_address(_points), buffer_get_size(_points));
 ...
 * @returns {Real}
 */
function fmod_sound_get_3d_custom_rolloff(_sound_ref, _points)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
 ...
 * @param {Enum.FmodTimeUnit} _offset_type
 * @returns {Struct.FmodSyncPointInfo}
 */
function fmod_sound_get_sync_point(_sound_ref, _sync_point_index, _offset_type)
{
    ...
    // param: _offset_type, type: enum FmodTimeUnit

    if (!is_numeric(_offset_type)) show_error($"{_GMFUNCTION_} :: _offset_type expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _offset_type);
...
function fmod_sound_get_user_data(_sound_ref)
{
    ...
    var __return_value__ = __fmod_sound_get_user_data(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function fmod_sound_get_num_tags(_sound_ref)
{
    ...
    var __return_value__ = __fmod_sound_get_num_tags(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));

    var __result__ = undefined;
    __result__ = __FmodSoundNumTags_decode(__ret_buffer__, buffer_tell(__ret_buffer__));
    return __result__;
}
 ...
 * @param {Bool} _propagate_dsp_clock
 * @returns {Real}
 */
function fmod_channel_group_add_group(_channel_group_ref, _child_channel_group_ref, _propagate_dsp_clock)
{
    ...
    // param: _propagate_dsp_clock, type: Bool
    if (!is_bool(_propagate_dsp_clock)) show_error($"{_GMFUNCTION_} :: _propagate_dsp_clock expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _propagate_dsp_clock);
...
/**
 * @param {Real} _channel_group_ptr
 * @returns {Real}
 */
function fmod_channel_group_adopt(_channel_group_ptr)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    // param: _channel_group_ptr, type: UInt64
    if (!is_numeric(_channel_group_ptr)) show_error($"{_GMFUNCTION_} :: _channel_group_ptr expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _channel_group_ptr);

    var __ret_buffer__ = __ext_core_get_ret_buffer();

    var __return_value__ = __fmod_channel_group_adopt(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
/**
 * @param {Real} _sound_group_ref
 * @param {Enum.FmodSoundGroupBehavior} _behavior
 * @returns {Real}
 */
function fmod_sound_group_set_max_audible_behavior(_sound_group_ref, _behavior)
{
    ...
    // param: _behavior, type: enum FmodSoundGroupBehavior

    if (!is_numeric(_behavior)) show_error($"{_GMFUNCTION_} :: _behavior expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _behavior);
...
function fmod_sound_group_get_max_audible_behavior(_sound_group_ref)
{
    ...
    var __return_value__ = __fmod_sound_group_get_max_audible_behavior(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function fmod_sound_group_get_user_data(_sound_group_ref)
{
    ...
    var __return_value__ = __fmod_sound_group_get_user_data(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function fmod_reverb_3d_get_user_data(_reverb_3d_ref)
{
    ...
    var __return_value__ = __fmod_reverb_3d_get_user_data(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
 ...
 */
function fmod_channel_control_get_fade_points(_channel_control_ref)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    var __return_value__ = __fmod_channel_control_get_fade_points(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
    ...
    {
        __result__[_i] = __FmodFadePoint_decode(__ret_buffer__, buffer_tell(__ret_buffer__));
    }
    return __result__;
}
...
function fmod_channel_control_get_mode(_channel_control_ref)
{
    ...
    var __return_value__ = __fmod_channel_control_get_mode(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function fmod_channel_control_set_volume_ramp(_channel_control_ref, _ramp)
{
    ...
    // param: _ramp, type: Bool
    if (!is_bool(_ramp)) show_error($"{_GMFUNCTION_} :: _ramp expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _ramp);
...
function fmod_channel_control_set_mute(_channel_control_ref, _mute)
{
    ...
    buffer_write(__args_buffer__, buffer_bool, _mute);
...
function fmod_channel_control_set_3d_distance_filter(_channel_control_ref, _custom, _custom_level, _center_freq)
{
    ...
    // param: _custom, type: Bool
    if (!is_bool(_custom)) show_error($"{_GMFUNCTION_} :: _custom expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _custom);
 ...
 * @returns {Real}
 */
function fmod_channel_control_get_3d_custom_rolloff(_channel_control_ref, _points)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
    ...
    var __return_value__ = __fmod_channel_control_get_3d_custom_rolloff(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__));
...
function fmod_channel_control_set_mix_levels_input(_channel_control_ref, _levels, _num_levels)
{
    ...
    // param: _levels, type: Buffer
    if (!buffer_exists(_levels)) show_error($"{_GMFUNCTION_} :: _levels expected Id.Buffer", true);
    __GMFMOD_queue_buffer(buffer_get_address(_levels), buffer_get_size(_levels));
 ...
 * @returns {Struct.FmodDSPMixMatrix}
 */
function fmod_channel_control_get_mix_matrix(_channel_control_ref, _matrix, _in_channel_hop)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
...
function fmod_channel_control_get_user_data(_channel_control_ref)
{
    ...
    var __return_value__ = __fmod_channel_control_get_user_data(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function fmod_channel_control_set_delay(_channel_ref, _dspclock_start, _dspclock_end, _stop_channels)
{
    ...
    // param: _stop_channels, type: Bool
    if (!is_bool(_stop_channels)) show_error($"{_GMFUNCTION_} :: _stop_channels expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _stop_channels);
 ...
 * @returns {Real}
 */
function fmod_channel_control_set_callback(_channel_control_ref, _callback)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
 ...
 * @param {Enum.FmodDspConnectionType} _dsp_connection_type
 * @returns {Real}
 */
function fmod_dsp_add_input(_dsp_ref, _dsp_input_ref, _dsp_connection_type)
{
    ...
    // param: _dsp_connection_type, type: enum FmodDspConnectionType

    if (!is_numeric(_dsp_connection_type)) show_error($"{_GMFUNCTION_} :: _dsp_connection_type expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _dsp_connection_type);
...
function fmod_dsp_disconnect_all(_dsp_ref, _inputs, _outputs)
{
    ...
    // param: _inputs, type: Bool
    if (!is_bool(_inputs)) show_error($"{_GMFUNCTION_} :: _inputs expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _inputs);

    // param: _outputs, type: Bool
    if (!is_bool(_outputs)) show_error($"{_GMFUNCTION_} :: _outputs expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _outputs);
...
function fmod_dsp_set_parameter_bool(_dsp_ref, _index, _value)
{
    ...
    buffer_write(__args_buffer__, buffer_bool, _value);
...
function fmod_dsp_get_input(_dsp_ref, _index)
{
    ...
    var __result__ = undefined;
    __result__ = __FmodDSPConnectionEnd_decode(__ret_buffer__, buffer_tell(__ret_buffer__));
    return __result__;
}
...
/**
 * @param {Real} _dsp_ref
 * @param {Enum.FmodDspParameterDataType} _data_type
 * @returns {Real}
 */
function fmod_dsp_get_data_parameter_index(_dsp_ref, _data_type)
{
    ...
    // param: _data_type, type: enum FmodDspParameterDataType

    if (!is_numeric(_data_type)) show_error($"{_GMFUNCTION_} :: _data_type expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _data_type);
...
/**
 * @param {Real} _dsp_ref
 * @param {Enum.FmodChannelMask} _channel_mask
...
function fmod_dsp_set_channel_format(_dsp_ref, _channel_mask, _num_channels)
{
    ...
    // param: _channel_mask, type: enum FmodChannelMask

    if (!is_numeric(_channel_mask)) show_error($"{_GMFUNCTION_} :: _channel_mask expected number", true);
    buffer_write(__args_buffer__, buffer_u64, _channel_mask);
...
/**
 * @param {Real} _dsp_ref
 * @param {Bool} _input_enabled
 * @param {Bool} _output_enabled
 */
function fmod_dsp_set_metering_enabled(_dsp_ref, _input_enabled, _output_enabled)
{
    ...
    // param: _input_enabled, type: Bool
    if (!is_bool(_input_enabled)) show_error($"{_GMFUNCTION_} :: _input_enabled expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _input_enabled);

    // param: _output_enabled, type: Bool
    if (!is_bool(_output_enabled)) show_error($"{_GMFUNCTION_} :: _output_enabled expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _output_enabled);
...
function fmod_dsp_set_bypass(_dsp_ref, _bypass)
{
    ...
    // param: _bypass, type: Bool
    if (!is_bool(_bypass)) show_error($"{_GMFUNCTION_} :: _bypass expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _bypass);
...
function fmod_dsp_get_type(_dsp_ref)
{
    ...
    var __return_value__ = __fmod_dsp_get_type(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function fmod_dsp_get_user_data(_dsp_ref)
{
    ...
    var __return_value__ = __fmod_dsp_get_user_data(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
 ...
 * @returns {Struct.FmodDSPMixMatrix}
 */
function fmod_dsp_connection_get_mix_matrix(_connection_ref, _matrix, _in_channel_hop)
{
    var __available__ = __GMFMOD_is_available();
    if (!__available__) return;
...
function fmod_dsp_connection_get_type(_connection_ref)
{
    ...
    var __return_value__ = __fmod_dsp_connection_get_type(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function fmod_dsp_connection_get_user_data(_connection_ref)
{
    ...
    var __return_value__ = __fmod_dsp_connection_get_user_data(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function fmod_geometry_add_polygon(_geometry_ref, _direct_occlusion, _reverb_occlusion, _double_sided, _num_vertices, _vertices)
{
    ...
    // param: _double_sided, type: Bool
    if (!is_bool(_double_sided)) show_error($"{_GMFUNCTION_} :: _double_sided expected bool", true);
    buffer_write(__args_buffer__, buffer_bool, _double_sided);
...
function fmod_geometry_get_user_data(_geometry_ref)
{
    ...
    var __return_value__ = __fmod_geometry_get_user_data(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__), buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));
...
function __GMFMOD_get_decoders()
{
    static __decoders__ = [
        ...
        __FmodDSPDataParameterInfo_decode,
        __FmodErrorCallbackInfo_decode,
        __FmodSystemDeviceReinitialize_decode,
        __FmodSystemMemoryAllocationFailed_decode,
        __FmodSystemRecordPosition_decode,
        __FmodDSPWetDryMix_decode,
        __FmodDSPInfo_decode,
        __FmodDSPDescription_decode,
        __FmodDSPConnectionEnd_decode,
        ...
        __FmodChannelsPlaying_decode,
        __FmodDelay_decode,
        __FmodDSPClock_decode,
        __FmodSoundOpenState_decode,
        __FmodSoundTag_decode,
        __FmodSoundNumTags_decode,
        __FmodSoundFormatInfo_decode,
