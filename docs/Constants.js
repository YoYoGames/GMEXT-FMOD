 ...
 * @member PERSISTENT Persistent memory. Memory will be freed when ${function.fmod_system_release} is called.
 ...
 * @member PREFER_DOLBY_DOWNMIX When using `FMOD_SPEAKERMODE._5POINT1` with a stereo output device, use the Dolby Pro Logic II downmix algorithm instead of the default stereo downmix algorithm.
 ...
 * @member PROFILE_METER_ALL Slower, but adds level metering for every single DSP unit in the graph. Use ${function.fmod_dsp_set_metering_enabled} to turn meters off individually. Setting this flag implies `FMOD_INIT.PROFILE_ENABLE`.
 * @member MEMORY_TRACKING Enables memory allocation tracking. Currently this is only useful when using the Studio API. Increases memory footprint and reduces performance. This flag is implied by `FMOD_STUDIO_INIT.MEMORY_TRACKING`.
 * @const_end
 */
 ...
 * @member PREUPDATE Called at start of ${function.fmod_system_update} from the main (calling) thread when set from the Core API or Studio API in synchronous mode, and from the Studio Update Thread when in default / async mode.
 * @member POSTUPDATE Called at end of ${function.fmod_system_update} from the main (calling) thread when set from the Core API or Studio API in synchronous mode, and from the Studio Update Thread when in default / async mode.
 * @member RECORDLISTCHANGED Called from ${function.fmod_system_update} when the enumerated list of recording devices has changed. Called from the main (calling) thread when set from the Core API or Studio API in synchronous mode, and from the Studio Update Thread when in default / async mode.
 ...
 * @member DEVICEREINITIALIZE Called from ${function.fmod_system_update} when an output device is re-initialized. Called from the main (calling) thread when set from the Core API or Studio API in synchronous mode, and from the Studio Update Thread when in default / async mode.
 ...
 * @member OPENMEMORY When used, the first argument of ${function.fmod_system_create_sound} and ${function.fmod_system_create_stream}, name_or_data, is interpreted as a pointer to memory instead of filename for creating sounds. The following data must be provided using ${struct.FmodSystemCreateSoundExInfo}: cbsize, and length. If used with `FMOD_MODE.CREATESAMPLE` or `FMOD_MODE.CREATECOMPRESSEDSAMPLE`, FMOD duplicates the memory into its own buffers. Your own buffer can be freed after open, unless you are using `FMOD_MODE.NONBLOCKING` then wait until the Sound is in the `FMOD_OPENSTATE.READY` state. If used with `FMOD_MODE.CREATESTREAM`, FMOD will stream out of the buffer whose pointer you passed in. In this case, your own buffer should not be freed until you have finished with and released the stream.
 ...
 * @member AS_3D_CUSTOMROLLOFF This sound follows a roll-off model defined by ${function.fmod_sound_set_3d_custom_rolloff} / ${function.fmod_channel_control_set_3d_custom_rolloff}. This roll-off mode provides greater freedom and flexibility than any other, but must be defined manually.
 * @member AS_3D_IGNOREGEOMETRY Is not affected by geometry occlusion. If not specified in ${function.fmod_sound_set_mode}, or ${function.fmod_channel_control_set_mode}, the flag is cleared and it is affected by geometry again.
 ...
 * @member BACK_CENTER Back center channel, not represented in any ${constant.FMOD_SPEAKERMODE}.
 ...
 * @member MIXER Default priority for `FMOD_THREAD_TYPE.MIXER`.
 * @member FEEDER Default priority for `FMOD_THREAD_TYPE.FEEDER`.
 * @member STREAM Default priority for `FMOD_THREAD_TYPE.STREAM`.
 * @member FILE Default priority for `FMOD_THREAD_TYPE.FILE`.
 * @member NONBLOCKING Default priority for `FMOD_THREAD_TYPE.NONBLOCKING`.
 * @member RECORD Default priority for `FMOD_THREAD_TYPE.RECORD`.
 * @member GEOMETRY Default priority for `FMOD_THREAD_TYPE.GEOMETRY`.
 * @member PROFILER Default priority for `FMOD_THREAD_TYPE.PROFILER`.
 * @member STUDIO_UPDATE Default priority for `FMOD_THREAD_TYPE.STUDIO_UPDATE`.
 * @member STUDIO_LOAD_BANK Default priority for `FMOD_THREAD_TYPE.STUDIO_LOAD_BANK`.
 * @member STUDIO_LOAD_SAMPLE Default priority for `FMOD_THREAD_TYPE.STUDIO_LOAD_SAMPLE`.
 * @member CONVOLUTION1 Default priority for `FMOD_THREAD_TYPE.CONVOLUTION1`.
 * @member CONVOLUTION2 Default priority for `FMOD_THREAD_TYPE.CONVOLUTION2`.
 * @const_end
 */
 ...
 * @member STREAM Default stack size for `FMOD_THREAD_TYPE.STREAM`. Set to 96  * 1024.
 * @member FILE Default stack size for `FMOD_THREAD_TYPE.FILE`. Set to 64  * 1024.
 * @member NONBLOCKING Default stack size for `FMOD_THREAD_TYPE.NONBLOCKING`. Set to 112 * 1024.
 * @member RECORD Default stack size for `FMOD_THREAD_TYPE.RECORD`. Set to 16  * 1024.
 * @member GEOMETRY Default stack size for `FMOD_THREAD_TYPE.GEOMETRY`. Set to 48  * 1024.
 * @member PROFILER Default stack size for `FMOD_THREAD_TYPE.PROFILER`. Set to 128 * 1024.
 * @member STUDIO_UPDATE Default stack size for `FMOD_THREAD_TYPE.STUDIO_UPDATE`. Set to 96  * 1024.
 * @member STUDIO_LOAD_BANK Default stack size for `FMOD_THREAD_TYPE.STUDIO_LOAD_BANK`. Set to 96  * 1024.
 * @member STUDIO_LOAD_SAMPLE Default stack size for `FMOD_THREAD_TYPE.STUDIO_LOAD_SAMPLE`. Set to 96  * 1024.
 * @member CONVOLUTION1 Default stack size for `FMOD_THREAD_TYPE.CONVOLUTION1`.
 * @member CONVOLUTION2 Default stack size for `FMOD_THREAD_TYPE.CONVOLUTION2`.
 * @const_end
 */
 ...
 * @member MIXER Default affinity for `FMOD_THREAD_TYPE.MIXER`.
 * @member FEEDER Default affinity for `FMOD_THREAD_TYPE.FEEDER`.
 * @member STREAM Default affinity for `FMOD_THREAD_TYPE.STREAM`.
 * @member FILE Default affinity for `FMOD_THREAD_TYPE.FILE`.
 * @member NONBLOCKING Default affinity for `FMOD_THREAD_TYPE.NONBLOCKING`.
 * @member RECORD Default affinity for `FMOD_THREAD_TYPE.RECORD`.
 * @member GEOMETRY Default affinity for `FMOD_THREAD_TYPE.GEOMETRY`.
 * @member PROFILER Default affinity for `FMOD_THREAD_TYPE.PROFILER`.
 * @member STUDIO_UPDATE Default affinity for `FMOD_THREAD_TYPE.STUDIO_UPDATE`.
 * @member STUDIO_LOAD_BANK Default affinity for `FMOD_THREAD_TYPE.STUDIO_LOAD_BANK`.
 * @member STUDIO_LOAD_SAMPLE Default affinity for `FMOD_THREAD_TYPE.STUDIO_LOAD_SAMPLE`.
 * @member CONVOLUTION1 Default affinity for `FMOD_THREAD_TYPE.CONVOLUTION1`.
 * @member CONVOLUTION2 Default affinity for `FMOD_THREAD_TYPE.CONVOLUTION2`.
 ...
 * @member FMOD_PRESET_PADDEDCELL { decay_time:   170, early_delay:   1, late_delay:   2, hf_reference: 5000, hf_decay_ratio:  10, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:   160, early_late_mix:  84, wet_level:  -7.8 }
 * @member FMOD_PRESET_ROOM { decay_time:   400, early_delay:   2, late_delay:   3, hf_reference: 5000, hf_decay_ratio:  83, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  6050, early_late_mix:  88, wet_level:  -9.4 }
 * @member FMOD_PRESET_BATHROOM { decay_time:  1500, early_delay:   7, late_delay:  11, hf_reference: 5000, hf_decay_ratio:  54, diffusion: 100, density:  60, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  2900, early_late_mix:  83, wet_level:   0.5 }
 * @member FMOD_PRESET_LIVINGROOM { decay_time:   500, early_delay:   3, late_delay:   4, hf_reference: 5000, hf_decay_ratio:  10, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:   160, early_late_mix:  58, wet_level: -19.0 }
 * @member FMOD_PRESET_STONEROOM { decay_time:  2300, early_delay:  12, late_delay:  17, hf_reference: 5000, hf_decay_ratio:  64, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  7800, early_late_mix:  71, wet_level:  -8.5 }
 * @member FMOD_PRESET_AUDITORIUM { decay_time:  4300, early_delay:  20, late_delay:  30, hf_reference: 5000, hf_decay_ratio:  59, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  5850, early_late_mix:  64, wet_level: -11.7 }
 * @member FMOD_PRESET_CONCERTHALL { decay_time:  3900, early_delay:  20, late_delay:  29, hf_reference: 5000, hf_decay_ratio:  70, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  5650, early_late_mix:  80, wet_level:  -9.8 }
 * @member FMOD_PRESET_CAVE { decay_time:  2900, early_delay:  15, late_delay:  22, hf_reference: 5000, hf_decay_ratio: 100, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut: 20000, early_late_mix:  59, wet_level: -11.3 }
 * @member FMOD_PRESET_ARENA { decay_time:  7200, early_delay:  20, late_delay:  30, hf_reference: 5000, hf_decay_ratio:  33, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  4500, early_late_mix:  80, wet_level:  -9.6 }
 * @member FMOD_PRESET_HANGAR { decay_time: 10000, early_delay:  20, late_delay:  30, hf_reference: 5000, hf_decay_ratio:  23, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  3400, early_late_mix:  72, wet_level:  -7.4 }
 * @member FMOD_PRESET_CARPETTEDHALLWAY { decay_time:   300, early_delay:   2, late_delay:  30, hf_reference: 5000, hf_decay_ratio:  10, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:   500, early_late_mix:  56, wet_level: -24.0 }
 * @member FMOD_PRESET_HALLWAY { decay_time:  1500, early_delay:   7, late_delay:  11, hf_reference: 5000, hf_decay_ratio:  59, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  7800, early_late_mix:  87, wet_level:  -5.5 }
 * @member FMOD_PRESET_STONECORRIDOR { decay_time:   270, early_delay:  13, late_delay:  20, hf_reference: 5000, hf_decay_ratio:  79, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  9000, early_late_mix:  86, wet_level:  -6.0 }
 * @member FMOD_PRESET_ALLEY { decay_time:  1500, early_delay:   7, late_delay:  11, hf_reference: 5000, hf_decay_ratio:  86, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  8300, early_late_mix:  80, wet_level:  -9.8 }
 * @member FMOD_PRESET_FOREST { decay_time:  1500, early_delay: 162, late_delay:  88, hf_reference: 5000, hf_decay_ratio:  54, diffusion:  79, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:   760, early_late_mix:  94, wet_level: -12.3 }
 * @member FMOD_PRESET_CITY { decay_time:  1500, early_delay:   7, late_delay:  11, hf_reference: 5000, hf_decay_ratio:  67, diffusion:  50, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  4050, early_late_mix:  66, wet_level: -26.0 }
 * @member FMOD_PRESET_MOUNTAINS { decay_time:  1500, early_delay: 300, late_delay: 100, hf_reference: 5000, hf_decay_ratio:  21, diffusion:  27, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  1220, early_late_mix:  82, wet_level: -24.0 }
 * @member FMOD_PRESET_QUARRY { decay_time:  1500, early_delay:  61, late_delay:  25, hf_reference: 5000, hf_decay_ratio:  83, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  3400, early_late_mix: 100, wet_level:  -5.0 }
 * @member FMOD_PRESET_PLAIN { decay_time:  1500, early_delay: 179, late_delay: 100, hf_reference: 5000, hf_decay_ratio:  50, diffusion:  21, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  1670, early_late_mix:  65, wet_level: -28.0 }
 * @member FMOD_PRESET_PARKINGLOT { decay_time:  1700, early_delay:   8, late_delay:  12, hf_reference: 5000, hf_decay_ratio: 100, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut: 20000, early_late_mix:  56, wet_level: -19.5 }
 * @member FMOD_PRESET_SEWERPIPE { decay_time:  2800, early_delay:  14, late_delay:  21, hf_reference: 5000, hf_decay_ratio:  14, diffusion:  80, density:  60, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:  3400, early_late_mix:  66, wet_level:   1.2 }
 * @member FMOD_PRESET_UNDERWATER { decay_time:  1500, early_delay:   7, late_delay:  11, hf_reference: 5000, hf_decay_ratio:  10, diffusion: 100, density: 100, low_shelf_frequency: 250, low_shelf_gain: 0, high_cut:   500, early_late_mix:  92, wet_level:   7.0 }
 * @const_end
 */
 ...
 * @member ERR_FILE_COULDNOTSEEK Couldn't perform seek operation. This is a limitation of the medium (i.e. netstreams) or the file format.
 ...
 * @member ERR_INITIALIZED Cannot call this command after ${function.fmod_system_init}.
 * @member ERR_INTERNAL An error occured in the FMOD system. Use the logging version of FMOD for more information.
 * @member ERR_INVALID_FLOAT Value passed in was a `NaN`, `infinity` or denormalized float.
 ...
 * @member ERR_MEMORY_CANTPOINT Can't use `FMOD_MODE.OPENMEMORY_POINT` on non PCM source data, or non mp3/xma/adpcm data if `FMOD_MODE.CREATECOMPRESSEDSAMPLE` was used.
 ...
 * @member ERR_OUTPUT_NODRIVERS The output device has no drivers installed. If pre-init, `FMOD_OUTPUTTYPE.NOSOUND` is selected as the output mode. If post-init, the function just fails.
 ...
 * @member ERR_PLUGIN_RESOURCE A resource that the plugin requires cannot be allocated or found. (i.e. the DLS file for MIDI playback)
 ...
 * @member ERR_REVERB_INSTANCE Specified instance in ${struct.FmodReverbProperties} couldn't be set. Most likely because it is an invalid instance number or the reverb doesn't exist.
 ...
 * @member ERR_STUDIO_UNINITIALIZED The FMOD Studio System object is not yet initialized.
 ...
 * @member NOSOUND_NRT All - Non-realtime version of `FMOD_OUTPUTTYPE.NOSOUND`, one mix per ${function.fmod_system_update}.
 * @member WAVWRITER_NRT All - Non-realtime version of `FMOD_OUTPUTTYPE.WAVWRITER`, one mix per ${function.fmod_system_update}.
 ...
 * @member BITSTREAM Sound data is in its native compressed format. See `FMOD_MODE.CREATECOMPRESSEDSAMPLE`
 * @const_end
 */
 ...
 * @member STRING_UTF16 16bit UTF string. Assume little endian byte order. See ${struct.FmodSoundTag} structure for string length in bytes.
 * @member STRING_UTF16BE 16bit UTF string Big endian byte order. See ${struct.FmodSoundTag} structure for string length in bytes.
 * @member STRING_UTF8 8 bit UTF string. See ${struct.FmodSoundTag} structure for string length in bytes.
 * @const_end
 */
 ...
 * @member AUX Auxiliary output port, pass `FMOD_PORT_INDEX.NONE` as port index.
 * @const_end
 */
 ...
 * @member _2D_STEREO_SEPARATION Stereo-To-Surround Stereo For `FMOD_DSP_PAN_2D_STEREO_MODE_TYPE.DISCRETE` mode. Separation/width of L/R parts of stereo sound.
 * @member _2D_STEREO_AXIS Stereo-To-Surround Stereo For `FMOD_DSP_PAN_2D_STEREO_MODE_TYPE.DISCRETE` mode. Axis/rotation of L/R parts of stereo sound.
 ...
 * @member _3D_MIN_DISTANCE 3D volume attenuation minimum distance when `FMOD_DSP_OBJECTPAN.OVERRIDE_RANGE` is true.
 * @member _3D_MAX_DISTANCE 3D volume attenuation maximum distance when `FMOD_DSP_OBJECTPAN.OVERRIDE_RANGE` is true.
 ...
 * @member OVERALL_GAIN Overall gain to allow FMOD to know the DSP is scaling the signal for visualization purposes.
 * @member SURROUND_SPEAKER_MODE Surround speaker mode. (${constant.FMOD_SPEAKERMODE})
 * @member _2D_HEIGHT_BLEND 2D Height blend. When the input or `FMOD_DSP_PAN.SURROUND_SPEAKER_MODE` has height speakers, control the blend between ground and height. -1.0 (push top speakers to ground), 0.0 (preserve top / ground separation), 1.0 (push ground speakers to top).
 * @member ATTENUATION_RANGE Attenuation Range when `FMOD_DSP_OBJECTPAN.OVERRIDE_RANGE` is false.
 * @member OVERRIDE_RANGE Override Attenuation Range with `FMOD_DSP_PAN._3D_MIN_DISTANCE` and `FMOD_DSP_PAN._3D_MAX_DISTANCE`.
 * @const_end
 */
 ...
 * 
 * @member OUTPUTGROUPING Channel mix output grouping. (${constant.FMOD_DSP_CHANNELMIX_OUTPUT})
 ...
 * @member TRANSMITSPEAKERMODE Speaker mode (transmitter mode only). (${constant.FMOD_DSP_TRANSCEIVER_SPEAKERMODE})
 * @const_end
 */
 ...
 * @member _3D_MIN_DISTANCE 3D Min Distance when `FMOD_DSP_OBJECTPAN.OVERRIDE_RANGE` is true.
 * @member _3D_MAX_DISTANCE 3D Max Distance when `FMOD_DSP_OBJECTPAN.OVERRIDE_RANGE` is true.
 * @member _3D_EXTENT_MODE 3D Extent Mode.
 * @member _3D_SOUND_SIZE 3D Sound Size.
 * @member _3D_MIN_EXTENT 3D Min Extent.
 ...
 * @member ATTENUATION_RANGE Attenuation Range when `FMOD_DSP_OBJECTPAN.OVERRIDE_RANGE` is false.
 * @member OVERRIDE_RANGE Override Attenuation Range with `FMOD_DSP_OBJECTPAN._3D_MIN_DISTANCE` and `FMOD_DSP_OBJECTPAN._3D_MAX_DISTANCE`.
 * @const_end
 */
 ...
 * <br />
 * 
 * This constant holds the output plugin API version.
 * 
 * @const_end
 */
 ...
 * @member DEFERRED_CALLBACKS Defer timeline callbacks until the main update. See ${function.fmod_studio_event_instance_set_callback} for more information.
 * @member LOAD_FROM_UPDATE No additional threads are created for bank and resource loading. Loading is driven from ${function.fmod_studio_system_update}.
 * @member MEMORY_TRACKING Enables detailed memory usage statistics. Increases memory footprint and impacts performance. See ${function.fmod_studio_bus_get_memory_usage} and ${function.fmod_studio_event_instance_get_memory_usage} for more information. Implies `FMOD_INIT.MEMORY_TRACKING`.
 * @const_end
 */
 ...
 * @member LABELED Labeled discrete parameter that has a label for each integer value. This flag will never be set in banks built with FMOD Studio versions prior to 2.01.10. If this flag is set, `FMOD_STUDIO_PARAMETER_FLAGS.DISCRETE` will also be set.
 * @const_end
 */
 ...
 * @member ALL Pass this mask to ${function.fmod_studio_system_set_callback} to receive all callback types.
 * @const_end
 */
 ...
 * @member STARTED The event has commenced playing. Normally this callback will be issued immediately after `FMOD_STUDIO_EVENT_CALLBACK.STARTING`, but may be delayed until sample data has loaded. Parameters = unused.
 ...
 * @ref FMOD_DSP_PAN_2D_STEREO_MODE_TYPE
 * @ref FMOD_DSP_PAN_MODE_TYPE
 * @ref FMOD_DSP_PAN_3D_ROLLOFF_TYPE
 * @ref FMOD_DSP_PAN_3D_EXTENT_MODE_TYPE
 * @ref FMOD_DSP_PAN
 * @ref FMOD_DSP_THREE_EQ_CROSSOVERSLOPE_TYPE
 * @ref FMOD_DSP_THREE_EQ
 * @ref FMOD_DSP_FFT_WINDOW
 * @ref FMOD_DSP_FFT
 ...
 * @ref FMOD_DSP_CHANNELMIX_OUTPUT
 * @ref FMOD_DSP_CHANNELMIX
 * @ref FMOD_DSP_TRANSCEIVER_SPEAKERMODE
 ...
 * @ref FMOD_STUDIO_EVENT_CALLBACK
 * @ref FMOD_STUDIO_LOAD_BANK
 * @ref FMOD_STUDIO_COMMANDCAPTURE
 * @ref FMOD_STUDIO_COMMANDREPLAY
